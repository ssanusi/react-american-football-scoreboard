...
function App() {
  ...
  const handleHomeFieldGoal = e => setHomeScore(homeScore + 3);
  const handleAwayFieldGoal = e => setAwayScore(awayScore + 3);
  const handleHomeTouchDown = e => setHomeScore(homeScore + 7);
  const handleAwayTouchDown = e => setAwayScore(awayScore + 7);
